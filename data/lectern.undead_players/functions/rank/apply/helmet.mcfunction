...
scoreboard players remove @s lec.unpl.rank 19
...
execute unless score #best_helmet lec.unpl.rank >= @s lec.unpl.rank run scoreboard players operation #best_helmet lec.unpl.rank = @s lec.unpl.rank
