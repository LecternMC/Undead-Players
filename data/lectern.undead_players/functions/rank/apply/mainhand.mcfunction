...
scoreboard players remove @s lec.unpl.rank 3
...
execute unless score #best_mainhand lec.unpl.rank >= @s lec.unpl.rank run scoreboard players operation #best_mainhand lec.unpl.rank = @s lec.unpl.rank
